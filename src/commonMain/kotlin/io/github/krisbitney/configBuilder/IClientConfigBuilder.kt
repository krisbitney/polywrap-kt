...
interface IClientConfigBuilder {
     ...
     * @return This [IClientConfigBuilder] instance for chaining calls.
     */
    fun addEnv(env: Pair<String, WrapEnv>): IClientConfigBuilder
     ...
     * @return This [IClientConfigBuilder] instance for chaining calls.
     */
    fun addEnvs(envs: Map<String, WrapEnv>): IClientConfigBuilder
     ...
     * @return This [IClientConfigBuilder] instance for chaining calls.
     */
    fun setEnv(env: Pair<String, WrapEnv>): IClientConfigBuilder
