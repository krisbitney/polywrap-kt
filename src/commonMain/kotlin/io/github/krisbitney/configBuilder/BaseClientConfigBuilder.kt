...
abstract class BaseClientConfigBuilder : IClientConfigBuilder {
     ...
     * @return This [BaseClientConfigBuilder] instance for chaining calls.
     */
    override fun addEnv(env: Pair<String, WrapEnv>): IClientConfigBuilder = this.apply {
     ...
     * @return This [BaseClientConfigBuilder] instance for chaining calls.
     */
    override fun addEnvs(envs: Map<String, WrapEnv>): IClientConfigBuilder = this.apply {
     ...
     * @return This [BaseClientConfigBuilder] instance for chaining calls.
     */
    override fun setEnv(env: Pair<String, WrapEnv>): IClientConfigBuilder = this.apply {
